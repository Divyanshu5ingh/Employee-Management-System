...
public class EmpSysDbContext :
    AbpDbContext<EmpSysDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(EmpSysConsts.DbTablePrefix + "YourEntities", EmpSysConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});
        builder.Entity<Employee>(b =>
        {
            b.ToTable(EmpSysConsts.DbTablePrefix + "Employees",
