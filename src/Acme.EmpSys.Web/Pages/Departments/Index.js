$(function () {
    ...
    var dataTable = $('#DepartmentsTable').DataTable(
        abp.libs.datatables.normalizeConfiguration({
            ...
            searching: false,
            scrollX: true,
            ajax: abp.libs.datatables.createAjax(acme.empSys.departments.department.getList),
            columnDefs: [
                {
                    title: l('Actions'),
                    rowAction: {
                            ...
                            [
                                {
                                    text: l('Edit'),
                                    visible:
                                        abp.auth.isGranted('EmpSys.Departments.Edit'),
                                ...
                                },
                                {
                                    text: l('Delete'),
                                    visible:
                                        abp.auth.isGranted('EmpSys.Departmetns.Delete'),
                                    ...
                                    action: function (data) {
                                        acme.empSys.departments.department
